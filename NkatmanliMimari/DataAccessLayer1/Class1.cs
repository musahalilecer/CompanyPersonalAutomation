...
namespace DataAccessLayer1
{
    public class DALPersonel
    {
        public static List<EntityPersonel> PersonelListesi()
        {
            ...
            SqlCommand komut1 = new SqlCommand("select * from TblBilgi",Baglanti.baglanti);
        ...
        {
            SqlCommand komut2 = new SqlCommand("insert into TblBilgi (Ad,Soyad,Gorev,Sehir,Maas) values (@p1,@p2,@p3,@p4,@p5)",Baglanti.baglanti);
        ...
        {
            SqlCommand komut3 = new SqlCommand("delete from TblBilgi where Id=@p1", Baglanti.baglanti);
        ...
        {
            SqlCommand komut4 = new SqlCommand("update TblBilgi set Ad=@p1,Soyad=@p2,Sehir=@p3,Gorev=@p4,Maas=@p5 where Id=@p6",Baglanti.baglanti);
